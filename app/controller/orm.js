...
module.exports = class extends base {
   ...
   */
    async getSideBar() {
        let key = helper.md5('orm/sidebar');
        let data = this.app.app_debug ? null : await this.app.cache(key);
        if (!data) {
            let filePath = `${this.app.root_path}/doc/orm/sidebar.json`;
  ...
  */
    async getDoc(doc) {
        let markedContent;
        let filePath = `${this.app.root_path}/doc/orm/${doc}.md`;
   ...
   */
    async getMarkedContent(filePath) {
        let key = helper.md5('orm/' + filePath);
   ...
   */
    async getSearchResult(keyword) {
        ...
        let options = {
            cwd: this.app.root_path + `/doc/orm/`
        };
        ...
        data = Object.keys(data).map(item => {
            ...
            let filePath = `${this.app.root_path}/doc/orm/${itemData.filename}`;
